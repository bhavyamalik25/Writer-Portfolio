...
<p class="exp-section-heading">Areas I'm contributing to</p>
<ul>
...
<p>Those questions make product decisions feel less about aesthetics and more about clarity, trust, accessibility, and impact. The work is still evolving, and so is my understanding of how thoughtful products are built within collaborative environments.</p>`,
  ...
  itconsulting: {
    role:   'IT Consultant',
    co:     'Freelance Client',
    period: 'Remote · UK-Based Client · 1 Week',
    caseStudy: 'assets/BhavyaMalik_ITConsulting_CaseStudy.pdf',
    body: `
...
<p class="exp-section-heading">Deliverables</p>
<ul>
  <li>Requirement analysis summary</li>
  <li>Problem breakdown framework</li>
  <li>Priority mapping</li>
  <li>Timeline planning support</li>
  <li>Recommendations documentation</li>
  <li>Final summary report consolidating observations and suggested next steps</li>
</ul>

<p class="exp-section-heading">Outcomes for the Client</p>
<ul>
...
<p class="exp-section-heading">What I Learned</p>
<p>This engagement gave me practical exposure to working with ambiguous client requirements and transforming broad challenges into structured outputs. I strengthened my ability to conduct requirement gathering, break down complex workflows into organized frameworks, deliver structured outputs within short timelines, and work independently with an international client across a fully remote engagement.</p>
...
<p class="exp-section-heading">Key Areas</p>
<p style="font-size:13px; font-weight:300; color:#6A6A6A; line-height:1.8;">Requirement Gathering · Workflow Analysis · Project Planning · Documentation · Prioritization · Process Organization · Client Communication · Remote Collaboration · IT Consulting Support</p>

<p style="margin-top:8px; font-size:12px; font-style:italic; color:var(--muted);">Client identity and sensitive details withheld for confidentiality.</p>`,
    stack: [
      'Project Management', 'Problem Solving', 'Strategic Thinking',
      'Workflow Organization', 'Stakeholder Communication',
      'Execution Planning', 'Documentation', 'IT Consulting'
    ]
  }
};
